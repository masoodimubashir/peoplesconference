                        ...
                        <div class=" w-full space-y-8">
                            <form class="grid gap-8 grid-cols-1 " action="{{ route('member.update', [$member->id]) }}"
                                ...
                                dark:border-gray-600 dark:placeholder-gray-700 dark:text-white"
                                            ...
                                            <div class="md:grid md:grid-cols-2 md:space-x-4 w-full text-xs">
                                ...
                                dark:border-gray-600 dark:placeholder-gray-700 dark:text-white"
                                            ...
                                            <div class="mt-5 text-right md:space-x-3 md:block flex flex-col-reverse">
                                                <button type="submit"
                                                        class="mb-2 md:mb-0 bg-green-400 px-5 py-2 text-sm shadow-sm  tracking-wider text-white rounded-full hover:shadow-lg hover:bg-green-500">
                                                    Save
                                                </button>
                                            </div>
                                        </div>
